...
const Cart: React.FC = () => {
    ...
    const pizzasCount = items.reduce((sum: number, item: any) => sum + item.count, 0)

    const onClickClear = () => {
        window.confirm('Do you want to clear your cart?') && dispatch(clearItem())
    }
            ...
            <div className="cart">
                ...
                <div className="cart__bottom">
                    <div className="cart__bottom-details">
                        <span> Всего пицц: <b>{pizzasCount} шт.</b> </span>
